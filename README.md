...
6. To get the data from the MQTT broker you have multiple optoions:  
    ...
    - Or you can build a [MQTT to InfluxDB Bridge](https://diyi0t.com/visualize-mqtt-data-with-influxdb-and-grafana/). (The [script](https://github.com/KGeri201/THAPMU/MQTTInfluxDBBridge.py) is in the repository. Do not forget to download and enable the [service](https://github.com/KGeri201/THAPMU/mqttinfluxdbbridge.service) for the script))
