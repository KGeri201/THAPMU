...
I modified the circuit and the layout to fit the requirements of the esp and the sensor. I also replaced some of the parts with their easier to get and easier to solder counterparts.
